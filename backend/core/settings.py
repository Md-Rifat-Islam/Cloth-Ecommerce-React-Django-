...
MIDDLEWARE = [
    ...
    # Ensure this middleware is added:
...
LOGIN_REDIRECT_URL = 'http://localhost:5173/login/'  # Replace with your desired redirect URL after login

# Add additional configurations if needed, like logging, debugging, etc.
